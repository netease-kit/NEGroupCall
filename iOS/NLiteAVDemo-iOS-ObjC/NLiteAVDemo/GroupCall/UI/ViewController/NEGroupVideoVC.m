...
- (void)viewDidLoad {
    ...
    //美颜
    [[NETSFUManger shared] loadFilter];
    //数据
...
{
    [NERtcEngine.sharedEngine joinChannelWithToken:@"" channelName:self.task.avRoomCName myUid:self.task.avRoomUid completion:^(NSError * _Nullable error, uint64_t channelId, uint64_t elapesd) {
