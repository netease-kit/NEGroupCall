 ...
 * 视频通话三个用户时，第三个人的视图控件
 */
public class VideoCallThirdUserSpecialStyleItemView extends FrameLayout {
    private VideoCallBaseItemView videoCallBaseItemView;

    public VideoCallThirdUserSpecialStyleItemView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public VideoCallThirdUserSpecialStyleItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VideoCallThirdUserSpecialStyleItemView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    private void init(Context context) {
        inflate(context, R.layout.video_group_listitem_third_user_special_style_layout, this);
